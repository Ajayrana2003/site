...
import pageone from '../../asset/image/page4.png';
            ...
            <Row>
                ...
                <div className='section-title text-center'>   
                    <div className='intro-area-inner'>
                        ...
                        <h2 className='maintitle' > An exemplary<br></br>
                        learnng community</h2>

                        <Container className='text-center mt-5'>
                          <Row>
                            <Col lg={4} md={6} sm={12}>
                            <img src= {pageone} style={{ width: '350px', height: '200px', objectFit: 'cover' }}  />
                            ...
                            <p className="serviceDescription">Lorem ipsum dolor</p>
                             ...
                             <Col lg={4} md={6} sm={12}>
                             <img src= {pagetwo}  style={{ width: '350px', height: '200px', objectFit: 'cover' }} />
                             <h1 className='serviceName'>Teach Way you want</h1>
                             <p className="serviceDescription">Lorem ipsum dolor</p>
                            </Col>

                            <Col lg={4} md={6} sm={12}>
                            <img src= {pagethree} style={{ width: '350px', height: '200px', objectFit: 'cover' }} />
